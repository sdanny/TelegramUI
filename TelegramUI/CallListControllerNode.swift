...
final class CallListControllerNode: ASDisplayNode {
    ...
    init(context: AccountContext, mode: CallListControllerMode, presentationData: PresentationData, call: @escaping (PeerId) -> Void, playRecording: @escaping (PeerId, Int64) -> Void, emptyStateUpdated: @escaping (Bool) -> Void) {
